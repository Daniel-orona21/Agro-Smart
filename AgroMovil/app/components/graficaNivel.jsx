...
const GraficaNivel = () => {
  ...
  const { nivelValueAll } = useAuth();
  const nivel = nivelValueAll || []; // Manejamos el caso en que nivelValueAll sea null o undefined
  ...
  return (
    <LineChart
      data={{
        ...
        datasets: [
          {
            data: nivel.slice(0, 24) // Utilizamos slice para asegurarnos de que solo tomamos los primeros 24 elementos de nivel
          }
        ]
      }}
      width={windowWidth * 3}
